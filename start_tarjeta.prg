...
if type("oapp")<>"O"
   messagebox("No Se Pudo Instanciar la Aplicación",16,"Error General")
   set classlib to
   THROW "NORMAL"
ENDIF
...
oapp.salida=.t.
oapp.otitulo=glo_nom_emp && título de la Aplicación
*--- SECCION SCREEN -------------------------------------------------------------------------------------------*
